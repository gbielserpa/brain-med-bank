...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MEDRUN — Banco de Questões" },
      { name: "description", content: "Banco pessoal de questões de residência médica" },
      { property: "og:title", content: "MEDRUN — Banco de Questões" },
      { name: "twitter:title", content: "MEDRUN — Banco de Questões" },
      { property: "og:description", content: "Banco pessoal de questões de residência médica" },
      { name: "twitter:description", content: "Banco pessoal de questões de residência médica" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/eaec423a-115a-49cb-bd62-a28e4abb0679" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/eaec423a-115a-49cb-bd62-a28e4abb0679" },
